...
VAR_LABELS = {
    "pct_block_pass_p90": "Passes contrées",
    "pct_block_shot_p90": "Tirs contrés",
    "pct_carry_lost_pct": "Conduites de balle perdues (%)",
    "pct_carry_prog_p90": "Conduites progressives",
    "pct_challenge_att_p90": "Duels défensifs disputés",
    "pct_challenge_pct": "Duels défensifs gagnés (%)",
    "pct_degagement_p90": "Dégagements",
    "pct_duel_pct": "Duels aériens gagnés (%)",
    "pct_duel_play_p90": "Duels aériens disputés",
    "pct_erreur_opp_shot_p90": "Erreur menant à un tir adverse",
    "pct_faute_commise_p90": "Fautes commises",
    "pct_interception_p90": "Interceptions",
    "pct_pass_long_pct": "Passes longues réussies (%)",
    "pct_pass_med_pct": "Passes moyennes réussies (%)",
    "pct_pass_prog_p90": "Passes progressives",
    "pct_pass_short_pct": "Passes courtes réussies (%)",
    "pct_tacle_p90": "Tacles tentés",
    "pct_tacle_win_ball_pct": "Tacles réussis (%)",
    "pct_yellow_card_p90": "Carton jaune reçu",
    "pct_ballon_touche_surface_off_p90": "Ballons touchés surface adverse",
    "pct_carry_in_surface_p90": "Conduite surface adverse",
    "pct_dribble_att_p90": "Dribbles tentés",
    "pct_dribble_pct": "Dribbles réussis (%)",
    "pct_faute_won_p90": "Fautes provoquées",
    "pct_goals_no_pk_p90": "Buts inscrits hors penalty",
    "pct_offside_p90": "Hors-jeu",
    "pct_pass_profondeur_defense_p90": "Passes dos de la défense",
    "pct_pass_prog_recu_p90": "Passes progressives reçues",
    "pct_pass_shot_p90": "Passes amenant à un tir",
    "pct_pass_surface_cmp_p90": "Passes réussies dans la surface adverse",
    ...
    "pct_passe_att_p90": "Passes tentées",
    "pct_shots_p90": "Tirs tentés",
    "pct_touch_med_p90": "Ballons touchés milieu",
    "pct_touch_off_p90": "Ballons touchés offensif",
    "pct_centre_p90": "Centres tentés",
    "pct_centre_surface_cmp_p90": "Centres réussies dans la surface adverse",
    "pct_pass_transversal_p90": "Passes transversales",
}
...
with col_left:
    ...
    st.markdown(f"<div style='font-size:45px; font-weight:700; margin-top:8px; margin-left:60px; '>{poste}</div>", unsafe_allow_html=True)
...
with col_right:
    ...
    st.markdown(
        ...
        .radar-caption { 
            position: absolute;
            bottom: 20px;     /* distance du bas de l'image */
            right: 0;
            font-weight: 800;
            text-align: right;
            width: 100%;
